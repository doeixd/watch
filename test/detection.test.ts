  ...
  describe("Context Stack Detection", () => {
    it("should detect generator context when context is pushed", () => {
      ...
      try {
        ...
        expect(result.context).toBe(ApiContext.ASYNC_GENERATOR);
    ...
    it("should properly detect context in nested generators", () => {
      ...
      try {
        ...
        expect(result1.context).toBe(ApiContext.ASYNC_GENERATOR);
        ...
        try {
          ...
          expect(result2.context).toBe(ApiContext.ASYNC_GENERATOR);
        ...
        expect(result3.context).toBe(ApiContext.ASYNC_GENERATOR);
      ...
      expect(result4.context).not.toBe(ApiContext.ASYNC_GENERATOR);
    });
  });
