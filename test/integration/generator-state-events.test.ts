  ...
  describe('Basic State Operations', () => {
    ...
    it('should update state with updater function', async () => {
      ...
      await watch(element, async function* () {
        ...
        const newValue = yield* updateState<number>('counter', (current = 0) => current + 1);
  ...
  describe('Specialized State Operations', () => {
    ...
    it('should remove items from array state', async () => {
      ...
      await watch(element, async function* () {
        ...
        // Remove by predicate
        const removed2 = yield* removeFromState('items', (item: string) => item === 'b');
    ...
    it('should merge state objects', async () => {
      ...
      await watch(element, async function* () {
        ...
        // Deep merge
        const merged2 = yield* mergeState('config', {
          features: {
            spellCheck: true,
            newFeature: true
          }
  ...
  describe('State Utilities', () => {
    ...
    it('should use computed state', async () => {
      ...
      await watch(element, async function* () {
        ...
        // Computed state
        const fullName = yield* computedState(['firstName', 'lastName'], (deps) => {
        ...
        const fullName2 = yield* computedState(['firstName', 'lastName'], (deps) => {
          return `${deps.firstName} ${deps.lastName}`;
        });
  ...
  describe('Event Handling', () => {
    ...
    it('should handle custom events', async () => {
      ...
      await watch(element, async function* () {
        ...
        setTimeout(() => {
          yield* emit('customEvent', { message: 'Hello', value: 42 });
        }, 10);
      });
